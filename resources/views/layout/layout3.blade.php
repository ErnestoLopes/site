...
<body class="index-page">
 <header id="header3" class="header  align-items-center sticky-top">
    ...
    <img src="{{asset('site/img/flyer-CERTO.png')}}" class="logo"alt="logo" > 
      ...
      <nav id="navmenu1" class="navmenu">
        <ul>
          ...
          <div id="la"><li class="{{ request()->is('serviços') ? 'active' : '' }} dropdown"><a href="#"><span>Serviços</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
      ...
      <a class="btn-getstarted" href="https://wa.me/244944884849" target="_blank" >Fale Connosco</a>

    </div> 
    <h1><strong>Solicite uma proposta</strong></h1>
  </header>
